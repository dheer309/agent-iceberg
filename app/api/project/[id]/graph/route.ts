  ...
  nodes: [
    {
      ...
      type: 'model',
      position: { x: 250, y: 0 },
      data: { label: 'Parse User Query', description: 'Extract intent and entities' },
    },
    {
      id: '2',
      type: 'tool',
    ...
    },
    {
      ...
      data: { label: 'Decision Point', description: 'Choose response strategy' },
    },
    {
      id: '5',
      type: 'model',
      position: { x: 100, y: 450 },
      data: { label: 'Generate Response A', description: 'Standard response path' },
    },
    {
      id: '6',
      type: 'user',
